...
import { fadeIn, stagger, slideInLeftFast, slideInRightFast } from '../components/animations';
...
export default function Home() {
    ...
    return (
        <motion.div initial="initial" animate="animate">
            ...
            <motion.div variants={stagger} className='h-screen px-6 md:px-16 lg:px-28 py-1'>
                <NavBar />
                <div className='flex flex-wrap md:mt-10 lg:mt-0'>
                    <motion.div variants={slideInLeftFast} className='px-5 py-15 lg:px-10 lg:py-20 md:order-first md:flex-1'>
                    ...
                    <motion.div variants={slideInRightFast} className='p-8 order-first lg:p-16 md:flex-1 md:h-80 lg:h-96 overflow-hidden'>
                        <Image loader={imageLoader} src={Collage} alt="profile pic" className='rounded-lg' />
                    </motion.div>
                </div>

                <motion.div variants={fadeIn} className='w-full flex flex-wrap space-x-1 md:space-x-4 py-12 border-solid border-y-2 mt-5'>
                    <motion.div className='w-[48%] ml-1 md:flex-1'>
                ...
                <motion.div variants={fadeIn} className='py-10 text-center'>
                    <h5>Plus, here are some things that inspire me.</h5>
                </motion.div>


                <motion.div variants={fadeIn} className='flex flex-wrap space-y-4 w-full h-60 mb-5 p-5 md:space-y-0 md:space-x-2'>
