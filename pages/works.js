        ...
        <motion.div exit={{ opacity: 0 }} initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <div className='h-screen px-28 py-1'>
                ...
                <div className='grid md:grid-cols-3 gap-5 mb-5'>
                    <Link href="/">
                        <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff] cursor-pointer'>
                    ...
                    <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400'>
                        <Image src={Dash} alt="work 1" />
                    </div>
                    <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400'>
                        <Image src={Gree} alt="work 1" />
                    </div>
                </div>

                <div className='grid md:grid-cols-3 gap-8'>
                    <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400'>
                        <Image src={OplScreen} alt="work 1" />
                    </div>
                    <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400'>
                        <Image src={Dash} alt="work 1" />
                    </div>
